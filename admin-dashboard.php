...
try {
    ...
    $routeCapacity = [
        'Rooihuiskraal' => 60, // example capacity, replace with actual
        'Wierdapark' => 60,    // example capacity, replace with actual
        'Centurion' => 60      // example capacity, replace with actual
    ];
